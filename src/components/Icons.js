...
export const FacebookIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="#3b5998"
      d="M242.667 0H13.333A13.34 13.34 0 0 0 0 13.333v229.334A13.34 13.34 0 0 0 13.333 256h92.183V155.921h-24.649v-34.133h24.649V96.775c0-23.783 18.227-45.66 45.66-45.66h34.245v34.137h-21.41c-6.023 0-7.216 2.87-7.216 7.104v26.104h37.971l-4.953 34.133h-33.018V256h64.489a13.34 13.34 0 0 0 13.333-13.333V13.333A13.34 13.34 0 0 0 242.667 0z"
    />
  </svg>
);
// #0A66C2
...
export const MailIcon = ({ className, ...rest }) => (
  ...
  <path fill="#FF7F7F" d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 6.817h-18.779l5.513-6.812zm9.208-1.264l4.616-3.741v9.348l-4.616-5.607z" />
</svg>
